...
namespace ShuHai.Unity
{
    ...
    public class Tuple<T1, T2> : IEquatable<Tuple<T1, T2>>
    {
        ...
        public override int GetHashCode() { return HashCode.Get(Item1, Item2); }
    ...
    public class Tuple<T1, T2, T3> : IEquatable<Tuple<T1, T2, T3>>
    {
        ...
        public override int GetHashCode() { return HashCode.Get(Item1, Item2, Item3); }
    ...
    public class Tuple<T1, T2, T3, T4> : IEquatable<Tuple<T1, T2, T3, T4>>
    {
        ...
        public override int GetHashCode() { return HashCode.Get(Item1, Item2, Item3, Item4); }
