...
namespace ShuHai.Unity
{
    public static class CustomAttributeExtensions
    {
        ...
        public static IEnumerable<Attribute> GetCustomAttributes(
            this MemberInfo element, Type attributeType, bool inherit)
            => Attribute.GetCustomAttributes(element, attributeType, inherit);

        public static IEnumerable<Attribute> GetCustomAttributes(
            this ParameterInfo element, Type attributeType, bool inherit)
            => Attribute.GetCustomAttributes(element, attributeType, inherit);
        ...
        public static IEnumerable<T> GetCustomAttributes<T>(this ParameterInfo element, bool inherit)
            where T : Attribute => (IEnumerable<T>)GetCustomAttributes(element, typeof(T), inherit);

        #endregion APIs that return all attributes of a particular type

        #region IsDefined

        public static bool IsDefined<T>(this Assembly element) => IsDefined(element, typeof(T));

        public static bool IsDefined(this Assembly element, Type attributeType)
            => Attribute.IsDefined(element, attributeType);

        public static bool IsDefined<T>(this Module element) => IsDefined(element, typeof(T));

        public static bool IsDefined(this Module element, Type attributeType)
            => Attribute.IsDefined(element, attributeType);

        public static bool IsDefined<T>(this MemberInfo element) => IsDefined(element, typeof(T));

        public static bool IsDefined(this MemberInfo element, Type attributeType)
            => Attribute.IsDefined(element, attributeType);

        public static bool IsDefined<T>(this MemberInfo element, bool inherit)
            => IsDefined(element, typeof(T), inherit);

        public static bool IsDefined(this MemberInfo element, Type attributeType, bool inherit)
            => Attribute.IsDefined(element, attributeType, inherit);

        public static bool IsDefined<T>(this ParameterInfo element) => IsDefined(element, typeof(T));
